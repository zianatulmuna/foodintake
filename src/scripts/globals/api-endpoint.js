...
const API_ENDPOINT = {
  FOOD_POPULARITY: `${CONFIG.BASE_URL}recipes/complexSearch?sort=popularity&addRecipeNutrition=true&addRecipeInformation=true&${CONFIG.NUMBER_PAGE}&${CONFIG.API_KEY}`,
